...
public interface StudenteRepository extends JpaRepository<Studente, Integer>, JpaSpecificationExecutor<Studente> {
	...
	List<Studente> findByCognomeContaining(String nome);
...
//	}
	...
	static Specification<Studente> corsoAllIn(Corso corso) {
		return (studente, cq, cb) -> cb.isMember(corso,studente.get("corsi")); 
	}
